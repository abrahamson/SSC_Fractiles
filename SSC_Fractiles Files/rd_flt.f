     ...
     4    fname )
      ...
      integer nMaxMag(MAX_FLT,MAXPARAM), Attentype(MAX_FLT)
      real segwt(MAX_FLT,MAX_FLT), wt, al_segWt(MAX_FLT)
      real minmag, magstep, minDepth
      real bValueWt(MAXPARAM),
     1     magRecurWt(MAXPARAM), 
     3     dipWt(MAXPARAM)
      integer nFlt0, nFlt2
